...
import NotFoundData from "@/shared/components/fallbacks/NotFoundData"
...
const SectionLabel: React.FC<{ children: React.ReactNode }> = ({
  ...
  <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-white mb-3">
    {children}
  </p>
);
...
const InfoRow: React.FC<{
  ...
  const content = (
    <div className="flex items-center gap-2.5 text-sm text-white/80 group">
      <span className="text-white/35 group-hover:text-white transition-colors duration-200">
        {icon}
      </span>
      <span
        className={`truncate ${href ? "group-hover:text-white group-hover:underline underline-offset-2 transition-colors duration-200" : ""}`}
      >
        {value}
      </span>
    </div>
...
const EditPanel: React.FC<EditPanelProps> = ({ profile, onSave, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-black z-50 shadow-2xl flex flex-col"
      ...
      >
        ...
        <div className="px-6 py-4 border-t border-black/8 flex items-center gap-3 flex-shrink-0 bg-black">
          <button
            type="submit"
            form="edit-form"
            className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold tracking-wide transition-all duration-200 active:scale-[0.98] ${
              isSuccess
                ? "bg-white text-black"
...
const UserProfile: React.FC = () => {
  ...
  if (!userProfile) {
    return (
      <NotFoundData Icon={UserX2} statusCode={404}/>
    );
  }
          ...
          <div className="flex flex-col gap-5 sm:gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              ...
              <div className="bg-white/5 border border-white/8  p-5 shadow-inner shadow-black">
                ...
                <div className="flex flex-col gap-3">
                  <div>
                    <p className="text-[10px] text-white uppercase tracking-widest mb-0.5">
                      Email
                    </p>
              ...
              <div className="bg-white/5 border border-white/8  p-5 shadow-inner shadow-black">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <span className="text-white group-hover:text-white/50 transition-colors duration-200 mt-0.5">
                      {Icon.link}
                    </span>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-white/70 group-hover:text-white/50 transition-colors duration-200">
                        View Profile →
                      </p>
                    </div>
                  </a>
