...
export function LoginForm() {
    ...
    return (
        /*  Page wrapper — full-screen dark navy  */
        <div className="min-h-screen bg-[#0A0F1E] flex items-center justify-center px-4">
            ...
            <div className="relative w-full max-w-md bg-[#111827] border border-[#1E2D45] rounded-2xl shadow-2xl shadow-blue-950/40 px-8 py-10">
                ...
                <div className="flex flex-col items-center gap-3 mb-8">
                    {/* Logo placeholder — swap <BrainCircuit> for your <Image> */}
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            className="
                                ...
                                bg-[#0D1526] border border-[#1E2D45]
                ...
                <p className="mt-6 text-center text-xs text-slate-600">
                    ...
                    <Link href="/register" className="text-blue-400 hover:text-blue-300 transition-colors duration-150">
                        Request access
                    </Link>
                </p>
            </div>
